#ifndef __UniversalSimpleNodeStrategyImpl_h__
#define __UniversalSimpleNodeStrategyImpl_h__ 1
...
namespace AdobeXMPCompareAndMerge_Int {
	...
	protected:
		virtual ~UniversalSimpleNodeStrategyImpl ( ) __NOTHROW__ {}
	};
}
