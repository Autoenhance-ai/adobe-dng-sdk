#ifndef __UniversalArrayOfSimpleNodeImpl_h__
#define __UniversalArrayOfSimpleNodeImpl_h__ 1
...
namespace AdobeXMPCompareAndMerge_Int {
	...
	protected:
		virtual ~UniversalArrayOfSimpleNodeImpl ( ) __NOTHROW__ {}
