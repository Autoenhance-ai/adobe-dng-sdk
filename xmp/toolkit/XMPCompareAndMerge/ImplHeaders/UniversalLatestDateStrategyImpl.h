#ifndef __UniversalLatestDateStrategyImpl_h__
#define __UniversalLatestDateStrategyImpl_h__ 1
...
namespace AdobeXMPCompareAndMerge_Int {
	...
	class UniversalLatestDateStrategyImpl
		: public virtual ThreeWayGenericStrategyImpl
	{
	public:
		UniversalLatestDateStrategyImpl() {}
		...
		static spIThreeWayGenericStrategy CreateUniversalLatestDateStrategyImpl();

	protected:
		virtual ~UniversalLatestDateStrategyImpl() __NOTHROW__ {}
...
#endif  // __UniversalLatestDateStrategyImpl_h__
