#ifndef __UniversalOldestDateStrategyImpl_h__
#define __UniversalOldestDateStrategyImpl_h__ 1
...
namespace AdobeXMPCompareAndMerge_Int {
	...
	class UniversalOldestDateStrategyImpl
		: public virtual ThreeWayGenericStrategyImpl
	{
	public:
		UniversalOldestDateStrategyImpl ( ) {}
		...
		static spIThreeWayGenericStrategy CreateUniversalOldestDateStrategyImpl ( );

	protected:
		virtual ~UniversalOldestDateStrategyImpl ( ) __NOTHROW__ {}
...
#endif  // __UniversalOldestDateStrategyImpl_h__
