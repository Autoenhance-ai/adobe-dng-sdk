...
#define zXMPFiles_GetVersion_1(versionInfo) \
	WXMPFiles_GetVersion_1 ( versionInfo /* no wResult */ )
...
// reactivate asap: extern void WXMPFiles_GetVersion_1 ( XMPFiles_VersionInfo * versionInfo );
