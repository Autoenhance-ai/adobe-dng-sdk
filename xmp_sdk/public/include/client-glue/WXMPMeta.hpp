...
typedef void (* XMP_AssertWrapperProc) ( XMP_AssertNotifyProc notifyProc,
                                         void *               refCon,
...
#define zXMPMeta_RegisterAssertNotify_1(wrapperProc,notifyProc,refCon) \
    WXMPMeta_RegisterAssertNotify_1 ( wrapperProc, notifyProc, refCon, &wResult )

#define zXMPMeta_UnregisterAssertNotify_1(notifyProc) \
    WXMPMeta_UnregisterAssertNotify_1 ( notifyProc, &wResult )

#define zXMPMeta_SendAssertNotify_1(message) \
    WXMPMeta_SendAssertNotify_1 ( message, &wResult )
...
extern void
WXMPMeta_RegisterAssertNotify_1 ( XMP_AssertWrapperProc wrapperProc,
...
extern void
WXMPMeta_SendAssertNotify_1 ( XMP_StringPtr message,
                              WXMP_Result * wResult );
...
extern void
WXMPMeta_MarkStaleProperties_1 ( XMPMetaRef     xmpRef,
                                 XMP_OptionBits options,
                                 WXMP_Result *  wResult );
