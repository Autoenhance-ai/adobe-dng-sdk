...
#define GIF_SIGNATURE_LEN		6
#define GIF_SIGNATURE_DATA	"\x47\x49\x46\x38\x39\x61" // must be GIF89a, nothing else
...
namespace GIF_Support 
{
	...
	long ReadHeader ( const XMP_PLUGIN::IOAdapter& file );
