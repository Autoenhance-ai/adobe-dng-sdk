#ifndef __LatestDateThreeWayGenericStrategyImpl_h__
#define __LatestDateThreeWayGenericStrategyImpl_h__ 1
...
namespace AdobeXMPCompareAndMerge_Int {
	...
	class LatestDateThreeWayGenericStrategyImpl
		: public virtual ThreeWayGenericStrategyImpl
	{
	public:
		LatestDateThreeWayGenericStrategyImpl() {}
		...
		static spIThreeWayGenericStrategy CreateLatestDateThreeWayGenericStrategy();

	protected:
		virtual ~LatestDateThreeWayGenericStrategyImpl() __NOTHROW__ {}
...
#endif  // __LatestDateThreeWayGenericStrategyImpl_h__
