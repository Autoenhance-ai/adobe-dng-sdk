#ifndef __MarkerThreeWayGenericStrategyImpl_h__
#define __MarkerThreeWayGenericStrategyImpl_h__ 1
...
namespace AdobeXMPCompareAndMerge_Int {
	class MarkerThreeWayGenericStrategyImpl
		: public virtual ThreeWayGenericStrategyImpl
	{
	public:
		MarkerThreeWayGenericStrategyImpl(){}
		...
		static spIThreeWayGenericStrategy CreateMarkerThreeWayGenericStrategy();

	protected:
		virtual ~MarkerThreeWayGenericStrategyImpl() __NOTHROW__ {}
