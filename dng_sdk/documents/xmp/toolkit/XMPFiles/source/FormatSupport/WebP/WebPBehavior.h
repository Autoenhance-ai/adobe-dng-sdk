...
#ifndef _WebPBEHAVIOR_h_
#define _WebPBEHAVIOR_h_
...
class WebPBehavior : public IChunkBehavior
{
public:
	/**
		ctor/dtor
	*/
					 WebPBehavior() : mChunksAdded(0) {}
					~WebPBehavior() {}
...
private:
	...
	/** WebP is always Little Endian */
	static const LittleEndian& mEndian;
